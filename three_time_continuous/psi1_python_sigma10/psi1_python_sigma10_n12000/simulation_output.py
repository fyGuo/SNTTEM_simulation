...
called by run_simulation.py for each (p_I1, p_I2, ph1, ph2) combination.

The simulation:
  1. Generates n=12000 observations per iteration.
...
if __name__ == "__main__":
    import time
    t0 = time.time()
    results = run_simulation(n=12000, n_iter=100, psi03=1, psi13=1, psi23=1,
                             p_I1=0.25, p_I2=0.25, ph1=0.30, ph2=0.30,
                             sigma=10, seed=3411)
