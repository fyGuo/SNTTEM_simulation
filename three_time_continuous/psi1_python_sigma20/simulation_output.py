...
def _one_iter(
    ...
    df = generate_data(n, psi03=psi03, psi13=psi13, psi23=psi23, p_I=p_I, ph=ph, rng=rng, sigma = sigma)
...
def run_simulation(
    ...
    if n_jobs == 1:
        results = [_one_iter(i=i, seed=seed, **common) for i in range(1, n_iter + 1)]
    else:
...
if __name__ == "__main__":
    ...
    results = run_simulation(n=6000, n_iter=100, psi03=0, psi13=0, psi23=0,
                             p_I=0.25, ph=0.30, sigma = 0, seed=3411)
