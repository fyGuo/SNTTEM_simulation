...
Mirrors the logic in check_results.ipynb (cells 5, 7, 11) so the PDFs can be
rebuilt headlessly after a new simulation run. Uses true psi = 0 (matching the
simulated data) for bias.
            ...
            for row_i, (pI1, pI2) in enumerate(pi_combos):
                for col_i, ph2 in enumerate(ph2_vals):
                    ...
                    for m_i, m in enumerate(METHODS):
                        ...
                        ax.bar(offsets, msub[metric].values, width=bar_width,
