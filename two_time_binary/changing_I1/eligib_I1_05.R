...
mod1 <- read_rds("mod1_ortho_p1_005.rds")
mod2 <- read_rds("mod2_ortho_p1_005.rds")
...
est$p_I1 <- p_I1
est %>% group_by(method) %>%
  summarise(mean_psi02 = mean(est_psi02),
          mean_psi12 = mean(est_psi12),
          sd_psi02 = var(est_psi02),
          sd_psi12 = var(est_psi12))
