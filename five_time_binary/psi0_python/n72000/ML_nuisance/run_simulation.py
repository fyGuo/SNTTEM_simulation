...
Production config: n=72000, ph in {0.3,0.5,0.8} (ph=0.3 replaces the earlier
ph=0.2 cell -- see scaletest_*_ph03_* in this directory for the n=48000/
72000/96000 stability comparison that motivated the swap). The archived
n=24000 config (ph in {0.2,0.5,0.8}) is preserved as run_simulation_n24000.py,
with its results kept as simulation_results_n24k.{pkl,csv}.
