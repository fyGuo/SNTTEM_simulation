#!/bin/bash
#
# Launch the five-time-point SNTTEM simulation (psi0, n=72000, 300 iterations).
#
#   ./run.sh
#
...
cd "$(dirname "$0")"
HERE="$(pwd -P)"
ROOT="$(cd "$HERE/../.." && pwd -P)"          # .../five_time_binary
...
main() {
    echo "=================================================================="
    echo "SNTTEM five-time-point simulation (psi0)"
    echo "=================================================================="
    echo "started     : $(date)"
    echo "host        : $(hostname)"
    echo "directory   : $HERE"
