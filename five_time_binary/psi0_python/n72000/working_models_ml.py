...
def working_model(
    ...
    if mu45:
        ...
        data.loc[data.index[id_2], "mu45"] = _classify(X1_tr, y1_tr, d2[cols].values)
        data.loc[data.index[id_1], "mu45"] = _classify(X2_tr, y2_tr, d1[cols].values)
    else:
    ...
    if mu35:
        ...
        data.loc[data.index[id_2], "mu35"] = _regress(X1_tr, y1_tr, d2[cols].values)
        data.loc[data.index[id_1], "mu35"] = _regress(X2_tr, y2_tr, d1[cols].values)
    else:
    ...
    if mu25:
        ...
        data.loc[data.index[id_2], "mu25"] = _regress(X1_tr, y1_tr, d2[cols].values)
        data.loc[data.index[id_1], "mu25"] = _regress(X2_tr, y2_tr, d1[cols].values)
    else:
    ...
    if mu15:
        ...
        data.loc[data.index[id_2], "mu15"] = _regress(X1_tr, y1_tr, d2[cols].values)
        data.loc[data.index[id_1], "mu15"] = _regress(X2_tr, y2_tr, d1[cols].values)
    else:
    ...
    if mu05:
        ...
        data.loc[data.index[id_2], "mu05"] = _regress(X1_tr, y1_tr, d2[["L0"]].values)
        data.loc[data.index[id_1], "mu05"] = _regress(X2_tr, y2_tr, d1[["L0"]].values)
    else:
