#!/bin/bash
#
# Launch the five-time-point SNTTEM simulation, ORACLE variant (psi0, n=72000,
# 300 iterations, all three estimators fitted with exact closed-form
# nuisances -- no ML, no cross-fitting).
#
#   ./run.sh
#
...
main() {
    echo "=================================================================="
    echo "SNTTEM five-time-point simulation (psi0, ORACLE nuisances)"
    echo "=================================================================="
    echo "started     : $(date)"
    echo "host        : $(hostname)"
    echo "directory   : $HERE"
