#!/bin/bash
#
# Launch the five-time-point SNTTEM simulation, ML-nuisance variant (psi1,
# n=144000, HARD CELL ONLY (p_I=0.2, ph=0.3), 300 iterations, nuisances fit
# with the RF/GBM/poly ensemble -- see ../oracle/ for the exact-closed-form-
# nuisance counterpart, and ../../n72000/ML_nuisance/ for the 6-cell
# n=72000 production grid this is testing against.
#
#   ./run.sh
#
...
main() {
    echo "=================================================================="
    echo "SNTTEM five-time-point simulation (psi1, ML nuisances)"
    echo "=================================================================="
    echo "started     : $(date)"
    echo "host        : $(hostname)"
    echo "directory   : $HERE"
