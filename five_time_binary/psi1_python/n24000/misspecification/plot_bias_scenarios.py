...
True psi = 1 here; empirical bias = mean(estimate) - 1. Dots show the Monte Carlo
mean bias; error bars span the 2.5th-97.5th Monte Carlo percentiles of the estimates.
